...
<div class="sidebar">
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            @endcan
            @if (auth()->user()->hasAnyPermission(['sale_create', 'product_view']))
            <li class="nav-item {{ request()->routeIs(['backend.admin.cart.index', 'backend.admin.products.index', 'backend.admin.products.edit']) ? 'menu-open' : '' }}">
                <a href="#" class="nav-link {{ request()->routeIs(['backend.admin.cart.index', 'backend.admin.products.index', 'backend.admin.products.edit']) ? 'active' : '' }}">
