        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($orders)
                ...
                ->addColumn('action', function ($data) {
                    ...
                    $buttons .= '<button class="btn btn-secondary btn-sm ml-1 mb-1" onclick="openPrintWindow(\'' . route('backend.admin.orders.pos-invoice', $data->id) . '\', \'PosInvoice\')"><i class="fas fa-file-invoice"></i> Pos Invoice</button>';
                    if (!$data->status) {
